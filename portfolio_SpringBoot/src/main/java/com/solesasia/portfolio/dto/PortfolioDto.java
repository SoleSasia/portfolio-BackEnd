...
public class PortfolioDto {
    ...
    public PortfolioDto(Long id, String nombre, String ocupacion, String bannerUrl, String email, String linkedinUrl, String githubUrl, String descripcion, String imgUrl, List<EduDto> educaciones, List<Experiencia> experiencias, List<HabilidadTecnica> habTecnicas, List<HabilidadBlanda> habBlandas, List<Proyecto> proyectos) {
        this.id = id;
        this.nombre = nombre;
